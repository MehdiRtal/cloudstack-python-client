...
from ...models.managed_credentials_service_type import ManagedCredentialsServiceType
...
def _get_kwargs(
    stack_id: UUID,
    service_type: ManagedCredentialsServiceType,
    service_id: UUID,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/users/me/stacks/{stack_id}/services/{service_type}/{service_id}/credentials/regenerate",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Regenerate Current User Stack Service Credentials

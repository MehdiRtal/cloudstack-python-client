...
def sync_detailed(
    ...
    *,
    ...
    """Get Current User Stack Services
    ...
    Returns:
        Response[Union[Any, HTTPValidationError, list[Union['FunctionServiceReadPublic', 'GithubServiceReadPublic', 'ImageServiceReadPublic', 'PostgresServiceReadPublic']]]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, HTTPValidationError, list[Union['FunctionServiceReadPublic', 'GithubServiceReadPublic', 'ImageServiceReadPublic', 'PostgresServiceReadPublic']]]
    """

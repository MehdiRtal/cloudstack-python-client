...
T = TypeVar("T", bound="GithubServiceReadPublic")


@_attrs_define
class GithubServiceReadPublic:
    """
    Attributes:
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        github_service_read_public = cls(
            name=name,
            type_=type_,
            resources_limit_cpu=resources_limit_cpu,
            resources_limit_memory=resources_limit_memory,
        ...
        github_service_read_public.additional_properties = d
        return github_service_read_public

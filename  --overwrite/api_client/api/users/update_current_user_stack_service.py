...
from ...models.function_service_update_public import FunctionServiceUpdatePublic
from ...models.github_service_read_public import GithubServiceReadPublic
from ...models.github_service_update_public import GithubServiceUpdatePublic
from ...models.http_validation_error import HTTPValidationError
from ...models.image_service_read_public import ImageServiceReadPublic
from ...models.image_service_update_public import ImageServiceUpdatePublic
from ...models.postgres_service_read_public import PostgresServiceReadPublic
from ...models.postgres_service_update_public import PostgresServiceUpdatePublic
...
def _get_kwargs(
    ...
    *,
    ...
    if isinstance(body, ImageServiceUpdatePublic):
        _kwargs["json"] = body.to_dict()
    elif isinstance(body, GithubServiceUpdatePublic):
        _kwargs["json"] = body.to_dict()
    elif isinstance(body, FunctionServiceUpdatePublic):
        _kwargs["json"] = body.to_dict()
    else:
        _kwargs["json"] = body.to_dict()
...
def sync_detailed(
    ...
    *,
    ...
    """Update Current User Stack Service

    Args:
        stack_id (UUID):
        service_id (UUID):
        body (Union['FunctionServiceUpdatePublic', 'GithubServiceUpdatePublic',
            'ImageServiceUpdatePublic', 'PostgresServiceUpdatePublic']):

...
T = TypeVar("T", bound="PostgresServiceBasePublic")


@_attrs_define
class PostgresServiceBasePublic:
    """
    Attributes:
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        postgres_service_base_public = cls(
            name=name,
            region=region,
            type_=type_,
        )

        postgres_service_base_public.additional_properties = d
        return postgres_service_base_public

...
T = TypeVar("T", bound="PostgresServiceReadPublic")


@_attrs_define
class PostgresServiceReadPublic:
    """
    Attributes:
        name (str):
        id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        postgres_service_read_public = cls(
            name=name,
            id=id,
            stack_id=stack_id,
            status=status,
        ...
        postgres_service_read_public.additional_properties = d
        return postgres_service_read_public

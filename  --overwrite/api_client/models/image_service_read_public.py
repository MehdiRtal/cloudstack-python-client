...
T = TypeVar("T", bound="ImageServiceReadPublic")


@_attrs_define
class ImageServiceReadPublic:
    """
    Attributes:
        name (str):
        type_ (Literal['image']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        image_service_read_public.additional_properties = d
        return image_service_read_public

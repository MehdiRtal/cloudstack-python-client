...
T = TypeVar("T", bound="FunctionServiceReadPublic")


@_attrs_define
class FunctionServiceReadPublic:
    """
    Attributes:
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        function_service_read_public = cls(
            name=name,
            type_=type_,
            resources_limit_cpu=resources_limit_cpu,
            resources_limit_memory=resources_limit_memory,
        ...
        function_service_read_public.additional_properties = d
        return function_service_read_public

...
T = TypeVar("T", bound="FunctionServiceUpdatePublic")


@_attrs_define
class FunctionServiceUpdatePublic:
    """
    Attributes:
        type_ (Union[Literal['function'], Unset]):  Default: 'function'.
    ...
    type_: Union[Literal["function"], Unset] = "function"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = cast(Union[Literal["function"], Unset], d.pop("type", UNSET))
        ...
        function_service_update_public = cls(
            type_=type_,
            runtime=runtime,
        ...
        function_service_update_public.additional_properties = d
        return function_service_update_public
